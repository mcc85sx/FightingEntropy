    ...
    Class V4Network
    {
        ...
        V4Network([String]$Network,[String]$Mask,[String]$Start,[String]$End,[String]$Broadcast,[String]$Range)
        {
    ...
    Class NetInterface
    {
        ...
        [V4Network] GetV4Network([Int32]$Prefix)
        {
            $ID                      = @{  
            ...
            Return [V4Network]::New($ID.Collect[0],$ID.Mask,$ID.Collect[1],$ID.Collect[-2],$ID.Collect[-1],$ID.Range)
        } 
    ...
    $Net.Interface 
    $Net.HostRange | Sort IPAddress | FT