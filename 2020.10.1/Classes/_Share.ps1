Class _Share
{
    ...
    FEShare([String]$ShareName,[String]$SharePath,[String]$FilesystemPath,[String]$Description)
    {
    ...
    New()
    {
        ...
        If ( $This.ShareName -in $This.Shares.Name -or $This.Root -in $This.Shares.Root )
        {
