...
Write-Theme "Purging/Building VM" 12,4,15
Start-Sleep 1
...
Set-VM $Name -ProcessorCount 4 -Verbose
...
Write-Theme "Starting [~] VM [$Name]" 11,3,15
...
Write-Theme "Install [~] CentOS 8" 14,6,15
Start-Sleep 1
...
Write-Theme "Network Menu" 14,6,15
Start-Sleep 1
...
Write-Theme "Installation Destination" 14,6,15
Start-Sleep 1
...
Write-Theme "Installation Source" 14,6,15
Start-Sleep 1
...
Write-Theme "Software Selection" 14,6,15
Start-Sleep 1
...
Write-Theme "Root password" 14,6,15
Start-Sleep 1
...
Write-Theme "Installing [~] CentOS" 10,2,15
Start-Sleep 1
...
Write-Theme "Installed [+] CentOS, Rebooting"
Start-Sleep 1
...
Write-Theme "Provisioning [~] Additional packages"
...
Invoke-KeyEntry $KB "IRM github.com/mcc85s/FightingEntropy/blob/main/Functions/Write-Theme.ps1?raw=true | IEX"
Start-Sleep -Milliseconds 100
$KB.TypeKey(13)
Start-Sleep 1

Invoke-KeyEntry $KB "Write-Theme -Flag"
$KB.TypeKey(13)
Start-Sleep 4
...
Invoke-KeyEntry $KB "create database roundcube default character set utf8 collate utf8_general_ci;"
Start-Sleep -Milliseconds 100
$KB.TypeKey(13)
Start-Sleep 1
...
Do
{
    ...
    $Log.Add($Log.Count,"[$($Time.Elapsed)] CentOS [~] Starting Apache Setbool")
    Write-Host $Log[$Log.Count-1]
    Start-Sleep 1
}
Until ($C.Count -gt 5)
