...
"@
    ...
    Class Main
    {
        ...
        {   # $Organization = "Secure Digits Plus LLC"; $CommonName = "securedigitsplus.com"
            ...
            $This.CN            = $CommonName
            $This.Template      = [Certificate]::New($Organization,$CommonName)
        ...
        {
            $This.Sitelist      = Get-ADObject -LDAPFilter "(objectClass=site)" -SearchBase $This.SearchBase
            Return @( $List | % { [Topography]$_ } )
        }
        [Void] NewDomain()
        {
            ForEach ( $Item in $This.Domain | % { [Topography]$_ } )
            {
                If ( $Item.Exists -eq 0 )
                {
        ...
        LoadNetwork([String]$Prefix)
        {
            ...
            Else
            {
                $This.Network    = @( [Network]::New($Prefix).Aggregate )
            }
        }
        GetGateway()
        {
...
#        ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯            
    ...
    {
        $Tmp                              = @( $Main.GetDomain($Main.Domain) | % { [Topography]$_ } )
        $Xaml.IO.DcTopography.ItemsSource = @( )
...
#        ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯            
    ...
    $Xaml.IO.NwAddSubnetName.Add_Click(
    {
        If ( $Xaml.IO.NwTopography.SelectedIndex -gt -1 )
        {
            ...
            If ( $Prefix -notin $Xaml.IO.NwTopography.Items.Name )
            {
    ...
    $Xaml.IO.NwRemoveSubnetName.Add_Click(
    {
        If ( $Xaml.IO.NwTopography.SelectedIndex -gt -1 )
        {
            ...
            $Xaml.IO.NwTopography.ItemsSource = @( )
            $Xaml.IO.NwTopography.ItemsSource = $Tmp | ? Name -ne $Xaml.IO.NwTopography.SelectedItem.Name
        }
    })
    ...
    $Xaml.IO.NwGetSubnetName.Add_Click(
    {
        ...
        ForEach ( $Item in $Main.SubnetList )
        {
    ...
    $Xaml.IO.NwNewSubnetName.Add_Click(
    {
        ...
        {
            If ( $Item.Name -notin $Main.SubnetList.Name )
            {
