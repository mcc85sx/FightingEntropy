...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid>
        ...
        <Grid Grid.Column="1" Name="_UIDPanel" Visibility="Visible">
            <Grid.RowDefinitions>
                <RowDefinition Height="40"/>
            ...
            <Grid Grid.Row="1" Name="_ViewUIDPanel" Visibility="Visible">
                <Grid.RowDefinitions>
...
"@
    ...
    $Cim.IO._NewClientTab.Add_Click{ 
        ...
        $Cim.Refresh()
        $Cim.IO._GetClientSearchResult.Items.Clear()
    }
    ...
    $Cim.IO._NewServiceTab.Add_Click{ 
        ...
        $Cim.Refresh()
        $Cim.IO._GetServiceSearchResult.Items.Clear()
    }
    ...
    $Cim.IO._NewDeviceTab.Add_Click{ 
        ...
        $Cim.Refresh()
        $Cim.IO._GetDeviceSearchResult.Items.Clear()
    }
    ...
    $Cim.IO._NewIssueTab.Add_Click{ 
        ...
        $Cim.Refresh()
        $Cim.IO._GetIssueSearchResult.Items.Clear()
    }
    ...
    $Cim.IO._NewInventoryTab.  Add_Click{ 
        ...
        $Cim.Refresh()
        $Cim.IO._GetInventorySearchResult.Items.Clear()
    }
    ...
    $Cim.IO._NewPurchaseTab.   Add_Click{ 
        ...
        $Cim.Refresh()
        $Cim.IO._GetPurchaseSearchResult.Items.Clear()
    }
    ...
    $Cim.IO._NewExpenseTab.Add_Click{ 
        ...
        $Cim.Refresh()
        $Cim.IO._GetExpenseSearchResult.Items.Clear()
    }
    ...
    $Cim.IO._NewAccountTab.Add_Click{ 
        ...
        $Cim.Refresh()
        $Cim.IO._GetAccountSearchResult.Items.Clear()
    }
    ...
    $Cim.IO._NewInvoiceTab.Add_Click{ 
        ...
        $Cim.Refresh()
        $Cim.IO._GetInvoiceSearchResult.Items.Clear()
    }
