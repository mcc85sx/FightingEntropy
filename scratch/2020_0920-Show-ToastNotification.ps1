...
# $URL = "https://raw.githubusercontent.com/secure-digits-plus-llc/FightingEntropy/master/Graphics/logo.jpg"

# Show-ToastNotification -Type 4 -Image $URL -GUID ( New-GUID ) -Header "Secure Digits Plus LLC" -Body "Fighting Entropy" -Footer ( Get-Date -Format HH:mm:ss )
