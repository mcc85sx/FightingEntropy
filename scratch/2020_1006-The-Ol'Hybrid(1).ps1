    ...
    [FirewallRule]::New("SDI","Snappy Driver Installer [In]","Inbound","C:\PathToSnappy","LocalSubnet","Allow")
    [FirewallRule]::New("SDI","Snappy Driver Installer [Out]","OutBound","C:\PathToSnappy","LocalSubnet","Allow")
